    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnsax:
                ...
                mAdapter = new ArrayAdapter<Person>(XmlParserActivity.this,
            ...
            case R.id.btndom:
                ...
                mAdapter = new ArrayAdapter<Person>(XmlParserActivity.this, android.R.layout.simple_expandable_list_item_1, persons);
                list.setAdapter(mAdapter);
                break;
            ...
            case R.id.btnpullwrite:
                ...
                File xmlFile = new File(context.getFilesDir(),"jay.xml");///data/user/0/com.bupt.net/files/jay.xml
